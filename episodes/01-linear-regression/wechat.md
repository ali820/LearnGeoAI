# 地学人工智能算法①：为什么山越高通常越冷？从线性回归开始

写给地学研究者的 AI 方法通识课  
从最经典、也最容易被低估的方法开始

很多人一提到“算法”，就会想到随机森林、神经网络、大模型，仿佛只有这些“新东西”才算人工智能。

但如果你真的做过地学研究，就会发现一个事实：

线性回归，可能是地学里最常用、最经典、也最有生命力的方法之一。
...
这也是我们学习 AI 方法时最重要的训练之一：不要只看模型输出，还要知道模型在回答什么问题、没有回答什么问题。
...
线性回归不是最复杂的算法，但它是地学 AI 最应该先掌握的方法之一。
...
从这一期开始，我们不是为了追逐复杂模型，而是先把地学 AI 的基本语言讲清楚。

下一期可以继续讲 Logistic 回归：当问题从“温度是多少”变成“某地是否发生滑坡”时，回归模型会如何改变？
